							...
							<div class="skin-theme-switcher">
								<div class="skin-theme-switcher">
									...
									<div class="pl-3 pr-3">
										...
										<a class="btn btn-warning btn-block" href="index.html">Leftmenu</a>
									</div>
									<div class="clearfix"></div>
									<h4>THEMES</h4>
									<div class="pl-3 pr-3">
										<a class="btn btn-primary btn-block" href="index.html">Leftmenu-Light</a> 
				...
				<ul class="side-menu ">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="darggablecards.html">Iron Study</a></li>
