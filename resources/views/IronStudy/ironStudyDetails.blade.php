            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="patient_id" class="w-50 form-control" id="" required  readonly>  
                    </div>

                    <div class="row row-sm  mt-3">
                        <div class="col">
                            <label for="">DOB</label>
                            <input type="date" name="date_of_birth" id="" class="form-control" required readonly>
                        </div>
    
                        <div class="col">
                            <label for="">Lab No</label>
                            <input type="text" name="Lab_number" id="" class="form-control" placeholder="Laboratory Number"  required readonly>
                        </div>
    
                        <div class="col">
                            <label for="">Date</label>
                            <input type="date" name="today_Date" id="" class="form-control"  required readonly>
                        </div>
                    </div>
